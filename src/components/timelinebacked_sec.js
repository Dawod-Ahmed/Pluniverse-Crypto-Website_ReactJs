  ...
  return (
    <>
      <div className="backedby_part d-flex flex-column align-items-center">
        <h1 className="backedby_header">BACKED BY</h1>
        <div className="backed_cards_parent d-flex justify-content-around w-100">
          {TimeLines_BackedImages.map((value, index) => {
            return (
              <>
                <div className="backed_card d-flex justify-content-center align-items-center px-3">
                  <img
